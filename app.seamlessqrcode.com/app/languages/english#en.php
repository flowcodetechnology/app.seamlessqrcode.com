...
return [
    ...
    'cron.email_reports.notice' => 'You\'re receiving these emails because you activated email reports. You can unsubscribe from the %slink settings%s page at any point in time.',
        ...
        // Flipbooks
    'flipbooks.breadcrumb' => 'Flipbooks',
    'flipbooks.title' => 'Flipbooks',
    'flipbooks.menu' => 'Flipbooks',
    'flipbooks.header' => 'Flipbooks',
    'flipbooks.subheader' => 'Create beautiful, interactive flipbooks from your PDF files.',
    'flipbooks.create' => 'Create Flipbook',
    'flipbooks.total' => '%s total flipbooks',
    'flipbooks.page_views' => '%s views',
    'flipbooks.no_data' => 'There are no flipbooks created yet.',
    'flipbooks.no_data_help' => 'Get started by creating your first flipbook.',

    // Flipbook Create
    'flipbook_create.breadcrumb' => 'Create Flipbook',
    'flipbook_create.header' => 'Create a new Flipbook',
    'flipbook_create.name_help' => 'An internal name for your flipbook, to help you identify it.',
    ...
    'flipbooks.settings.view_mode' => 'View Mode',
    'flipbooks.settings.view_mode_3d' => '3D Flipbook',
    'flipbooks.settings.view_mode_2d' => '2D Flipbook',
    'flipbooks.settings.view_mode_swipe' => 'Swipe',
    'flipbooks.settings.view_mode_scroll' => 'Scroll',
    'flipbooks.settings.single_page_view' => 'Single Page View',
    'flipbooks.settings.skin' => 'Skin',
    'flipbooks.settings.skin_dark' => 'Dark',
    'flipbooks.settings.skin_light' => 'Light',
    'flipbooks.settings.skin_gradient' => 'Gradient',
    'flipbooks.settings.page_shadows' => 'Page Shadows',
    'flipbooks.settings.page_shadows_help' => 'Display shadows on pages for a more realistic effect.',
    'flipbooks.settings.sound' => 'Flip Sound',
    'flipbooks.settings.sound_help' => 'Play a sound when the user turns a page.',
    'flipbooks.settings.fullscreen' => 'Fullscreen Button',
    'flipbooks.settings.thumbnails' => 'Thumbnails Button',
    'flipbooks.settings.table_of_contents' => 'Table of Contents Button',
    'flipbooks.settings.share' => 'Share Button',
    'flipbooks.settings.zoom' => 'Zoom Buttons',
    'flipbooks.settings.print' => 'Print Button',
    'flipbooks.settings.download' => 'Download PDF Button',
