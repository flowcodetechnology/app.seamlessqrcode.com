...
<div class="container">
    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('lifetime.breadcrumb') ?></li>
            </ol>
        </nav>
    <?php endif ?>

    <div class="d-flex align-items-center mb-4">
        <h1 class="h4 m-0"><?= l('lifetime.header') ?></h1>

        <div class="ml-2">
            <span data-toggle="tooltip" title="<?= l('lifetime.subheader') ?>">
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="ml-3"><i class="fas fa-fw fa-lg fa-headset text-primary"></i></div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="ml-3"><i class="fas fa-fw fa-lg fa-eye text-primary"></i></div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="ml-3"><i class="fas fa-fw fa-lg fa-bolt text-primary"></i></div>
                            </div>
    ...
    <div class="mt-5">
        ...
        $faq_keys = array_unique($faq_keys);
        ?>

        <div class="accordion index-faq mt-4" id="faq_accordion">
            <?php foreach($faq_keys as $key): ?>
                <div class="card">
                    <div class="card-body">
